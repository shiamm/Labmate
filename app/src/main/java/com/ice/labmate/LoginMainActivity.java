...
import com.ice.labmate.ICE8thSemester.ICE_8th_sem_MainActivity;
import com.ice.labmate.ICE7thSemester.ICE_7th_sem_MainActivity;
import com.ice.labmate.ICE6thSemester.ICE_6th_sem_MainActivity;
import com.ice.labmate.ICE5thSemester.ICE_5th_sem_MainActivity;
            ...
            public void onClick(View v) {
                ...
                snackbar.setAction("Contact Now", new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        boolean isGmailInstalled = isAppInstalled(LoginMainActivity.this, "com.google.android.gm");
                    ...
                    private boolean isAppInstalled(LoginMainActivity loginMainActivity, String s) {
                        return false;
                    }
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (txt_id.getText().toString().equals("")) {
                    ...
                    Intent intent = new Intent(LoginMainActivity.this, ICE_8th_sem_MainActivity.class);
                    startActivity(intent);
                    finish();
                    ...
                    Intent intent = new Intent(LoginMainActivity.this, ICE_7th_sem_MainActivity.class);
                    startActivity(intent);
                    finish();
                    ...
                    Intent intent = new Intent(LoginMainActivity.this, ICE_6th_sem_MainActivity.class);
                    startActivity(intent);
                    finish();
                    ...
                    Intent intent = new Intent(LoginMainActivity.this, ICE_5th_sem_MainActivity.class);
                    startActivity(intent);
                    finish();
